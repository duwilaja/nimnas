...
<input type="hidden" name="sv" value="NEW">
    <fieldset data-uk-margin>
		Table<br />
		<select name="tname">
			<option value="tick_ets">tick_ets (please use small number for rowid)</option>
		</select><br /><br />
        ...
        <button type="button" onclick="this.form.sv.value='NEW';this.form.submit();" class="uk-button uk-button-success uk-icon-plus"> Add (without rowid)</button>
...
<input type="hidden" name="sv" value="NEW">
    <fieldset data-uk-margin>
		Get Rowid from Ticket#<br />	
		<input type="text" name="ticketid" placeholder="ticketid" /><input onclick="getrowid(this.form.ticketid.value);" type="button" value="Get Rowid From Ticket#"><br /><br />
		Table<br />
		<select name="tname">
			<option value="tick_note">tick_note</option>
		</select>
		<br /><br />
