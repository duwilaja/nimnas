...
<input type="hidden" name="cols" value="servid,servname" />
<input type="hidden" name="tname" value="tick_serv" />
		  ...
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="servid" name="servid" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Name</label>
				<input type="text" id="servname" name="servname" placeholder="..." class="form-control">
			</div>
		  </div>
