...
<input type="hidden" name="cols" value="brid,brname" />
<input type="hidden" name="tname" value="ass_brand" />
		  ...
		  <div class="row">
			<div class="form-group col-md-12">
				<label>ID</label>
				<input type="text" id="brid" name="brid" placeholder="..." class="form-control">
			</div>
		  </div>
		  <div class="row">
			<div class="form-group col-md-12">
				<label>Name</label>
				<input type="text" id="brname" name="brname" placeholder="..." class="form-control">
			</div>
		  </div>
