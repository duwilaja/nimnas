		...
		<div id="header" class="app-header">
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
						<div class="menu-img online">
							<img src="<?php echo $s_AVATAR==""?"avatars/logo.jpg":"avatars/$s_AVATAR"?>" alt="Profile" height="60" />
						</div>
						<div class="menu-text d-sm-block d-none"><?php echo $s_ID==""?"Noone":$s_ID?></div>
					</a>
			...
			<!-- BEGIN menu-search -->
			<form class="menu-search" method="POST" name="header_search_form" action="n_device<?php echo $ext?>">
