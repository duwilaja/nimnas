...
//sla today
$sql="select dt,round(sum(uptime)/sum(uptime+downtime)*100,2) as sla from core_status_sla where dt >= (CURRENT_DATE - INTERVAL 1 MONTH) and $whrx group by dt order by dt";
